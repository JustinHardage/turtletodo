...
class WorklogsControllerTest < ActionController::TestCase
  ...
  test "should create worklog" do
    assert_difference('Worklog.count') do
      post :create, worklog: { endTime: @worklog.endTime, startTime: @worklog.startTime, taskID: @worklog.taskID }
    end
  ...
  test "should update worklog" do
    put :update, id: @worklog, worklog: { endTime: @worklog.endTime, startTime: @worklog.startTime, taskID: @worklog.taskID }
    assert_redirected_to worklog_path(assigns(:worklog))
  end
